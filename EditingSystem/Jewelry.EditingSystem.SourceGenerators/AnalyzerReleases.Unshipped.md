...
--------|----------|----------|-------
JES001 | Jewelry.EditingSystem | Error | Unsupported standalone Undoable partial property
JES002 | Jewelry.EditingSystem | Error | EditingHistory configuration is required
