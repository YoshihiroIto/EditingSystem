...
<div class="text-center py-4 py-md-5">
  ...
  <p>
    ...
    <a class="btn btn-outline-primary btn-lg me-2 mb-2" href="../demo/"><i class="bi bi-window-desktop me-2" aria-hidden="true"></i>デモを試す</a>
...
<p><a class="btn btn-primary" href="../demo/"><i class="bi bi-play-fill me-2" aria-hidden="true"></i>ブラウザで Avalonia デモを試す</a></p>
